...
export const createCourse = async (req, res) => {
    try {
        ...
        await User.updateMany({}, { $set: { newCourse: true } });
...
export const getAllCourses = async (req, res) => {
    try {
        ...
        await User.findByIdAndUpdate(req.headers["x-user-id"], { newCourse: false });
...
export const answerCourse = async (req, res) => {
    try {
        ...
        const existing = course.answers.find((a) => a.userId.toString() === userId);
